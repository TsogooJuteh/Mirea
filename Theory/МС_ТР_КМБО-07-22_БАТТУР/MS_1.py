...
df1 = pd.DataFrame(x_bi_save)
df1.to_excel('binomial.xlsx')
x_binom.sort()
x_bi_sorted_save = x_binom.copy().reshape((20, 10))
df = pd.DataFrame(x_bi_sorted_save)
df.to_excel('binomial_sorted.xlsx')
